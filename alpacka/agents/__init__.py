...
from alpacka.agents import best_first_search
...
def configure_agent(agent_class, blacklist=None):
    return gin.external_configurable(
        agent_class, module='alpacka.agents', blacklist=blacklist
    )
...
BestFirstSearchAgent = configure_agent(  # pylint: disable=invalid-name
    best_first_search.BestFirstSearchAgent,
    blacklist=['model_class']  # it should be specified in Runner.model_class
)
